...
namespace WinSupermercado {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductoRow AddProductoRow(string Descripcion, double PrecioUnidad, int Existencia, byte[] Foto, bool Activo, CategoriaRow parentCategoriaRowByCategoria_Producto, TipoRow parentTipoRowByTipo_Producto) {
        ...
        public partial class ProductoRow : global::System.Data.DataRow {
            ...
            public double PrecioUnidad {
                get {
                    return ((double)(this[this.tableProducto.PrecioUnidadColumn]));
                }
                set {
...
namespace WinSupermercado.DataSetTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Producto] WHERE (([id] = @Original_id) AND ([PrecioUnidad] = @Original_PrecioUnidad) AND ([Existencia] = @Original_Existencia) AND ([Activo] = @Original_Activo) AND ([CategoriaId] = @Original_CategoriaId) AND ([TipoId] = @Original_TipoId))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Producto] ([Descripcion], [PrecioUnidad], [Existencia], [Foto], [Activo], [CategoriaId], [TipoId]) VALUES (@Descripcion, @PrecioUnidad, @Existencia, @Foto, @Activo, @CategoriaId, @TipoId);
SELECT id, Descripcion, PrecioUnidad, Existencia, Foto, Activo, CategoriaId, TipoId FROM Producto WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Descripcion] = @Descripcion, [PrecioUnidad] = @PrecioUnidad, [Existencia] = @Existencia, [Foto] = @Foto, [Activo] = @Activo, [CategoriaId] = @CategoriaId, [TipoId] = @TipoId WHERE (([id] = @Original_id) AND ([PrecioUnidad] = @Original_PrecioUnidad) AND ([Existencia] = @Original_Existencia) AND ([Activo] = @Original_Activo) AND ([CategoriaId] = @Original_CategoriaId) AND ([TipoId] = @Original_TipoId));
SELECT id, Descripcion, PrecioUnidad, Existencia, Foto, Activo, CategoriaId, TipoId FROM Producto WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WinSupermercado.Properties.Settings.Default.ProductosSupermercadoConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Descripcion, PrecioUnidad, Existencia, Foto, Activo, CategoriaId, Tipo" +
                "Id FROM dbo.Producto";
        ...
        public virtual int Delete(int Original_id, double Original_PrecioUnidad, int Original_Existencia, bool Original_Activo, int Original_CategoriaId, int Original_TipoId) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_id));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((double)(Original_PrecioUnidad));
        ...
        public virtual int Insert(string Descripcion, double PrecioUnidad, int Existencia, byte[] Foto, bool Activo, int CategoriaId, int TipoId) {
            if ((Descripcion == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((double)(PrecioUnidad));
        ...
        public virtual int Update(string Descripcion, double PrecioUnidad, int Existencia, byte[] Foto, bool Activo, int CategoriaId, int TipoId, int Original_id, double Original_PrecioUnidad, int Original_Existencia, bool Original_Activo, int Original_CategoriaId, int Original_TipoId, int id) {
            if ((Descripcion == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((double)(PrecioUnidad));
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((double)(Original_PrecioUnidad));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Descripcion, double PrecioUnidad, int Existencia, byte[] Foto, bool Activo, int CategoriaId, int TipoId, int Original_id, double Original_PrecioUnidad, int Original_Existencia, bool Original_Activo, int Original_CategoriaId, int Original_TipoId) {
            return this.Update(Descripcion, PrecioUnidad, Existencia, Foto, Activo, CategoriaId, TipoId, Original_id, Original_PrecioUnidad, Original_Existencia, Original_Activo, Original_CategoriaId, Original_TipoId, Original_id);
        }
    }
